...
//
// El problema que resuelve: antes, los `catch`/`if (error)` de este
// proyecto mostraban `error.message` tal cual en un Swal.fire — el texto
// crudo de Postgres/PostgREST/Supabase Auth, siempre en inglés (ej.
...
// español y explique qué hacer, sin excepción.
//
// Ver también: el mismo archivo en los otros 4 repos Bridge
// (bridge-admin-web, bridge-alumno-front, bridge-psicologo-front,
 ...
 *                            (ej. "guardar las calificaciones"), usada solo
 *                            en el fallback genérico para dar contexto.
